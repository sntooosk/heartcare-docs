...
<div>
    <img src="Diagram_login.png" alt="Diagrama de Login" style="width: 300px; margin: 10px;">
    <img src="Diagram_register.png" alt="Diagrama de Registro" style="width: 300px; margin: 10px;">
    <img src="Diagram_resetPassword (1).png" alt="Diagrama de Redefinição de Senha" style="width: 300px; margin: 10px;">
</div>
